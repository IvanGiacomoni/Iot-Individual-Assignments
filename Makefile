...
MQTT_TOPIC_TEMP_SWITCH_MODE_DEVICE_1 = switchMode/device/1/temperature
MQTT_TOPIC_GAS_SMOKE_SWITCH_MODE_DEVICE_1 = switchMode/device/1/gas_smoke

CFLAGS += -DSERVER_ADDR='"$(SERVER_ADDR)"'
CFLAGS += -DSERVER_PORT=$(SERVER_PORT)
CFLAGS += -DMQTT_TOPIC_TEMP='"$(MQTT_TOPIC_TEMP)"'
CFLAGS += -DMQTT_TOPIC_GAS_SMOKE='"$(MQTT_TOPIC_GAS_SMOKE)"'
CFLAGS += -DMQTT_TOPIC_TEMP_SWITCH_MODE_DEVICE_1='"$(MQTT_TOPIC_TEMP_SWITCH_MODE_DEVICE_1)"'
CFLAGS += -DMQTT_TOPIC_GAS_SMOKE_SWITCH_MODE_DEVICE_1='"$(MQTT_TOPIC_GAS_SMOKE_SWITCH_MODE_DEVICE_1)"'
